...
export const post = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (userId && projectId && taskId) {
    try {
      ...
      // Console logs for debugging (can be removed if not needed)
      // console.log(`Comparing images: diffPixels=${compareImagDiff?.diffPixels}, total=${screenshotTotalPixels}, percent=${imageDiffPercent}%`);
